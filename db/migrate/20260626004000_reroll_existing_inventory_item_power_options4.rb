class RerollExistingInventoryItemPowerOptions4 < ActiveRecord::Migration[8.1]
  def up
    say_with_time "Rerolling existing inventory item Power options with corrected stat growth" do
